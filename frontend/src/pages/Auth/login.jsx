...
const Login = () => {
  ...
  return (
    <div>
      <section className="flex flex-col lg:flex-row items-center justify-center min-h-screen px-4 lg:px-24 bg-[#0f0f10]">
        <div className="w-full max-w-xl lg:mr-16 mt-10 ml-10">
          ...
          <form onSubmit={submitHandler} className="space-y-6">
            ...
            <button
              disabled={isLoading}
              type="submit"
              className="w-full bg-pink-500 hover:bg-pink-600 text-white font-medium py-2 px-6 rounded-md transition-colors disabled:opacity-50"
            >
